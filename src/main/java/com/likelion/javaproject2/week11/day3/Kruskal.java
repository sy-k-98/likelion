...
public class Kruskal {
    ...
    public void solution() throws IOException {
        ...
        // Kruskal 알고리즘은 서로소 집합의 개념을 이용해 서로 다른 두 정점을 연결했을 때 사이클이 발생하는지 안하는지 구분한다.
        // 배열로 표현한 트리를 만들기
        ...
        for (int i = 0; i < edgeCount; i++) {
            ...
            // 2-1. start와 end를 연결한 간선을 택하면 사이클이 생기지 않는지?
